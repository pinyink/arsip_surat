...
--
-- Host: 127.0.0.1
-- Generation Time: 16 Des 2018 pada 08.21
...
('asjkhakjsha', '57cdb6a3-e3c4-4660-9080-36ee39d0ce74', '2018-12-16 08:18:43');
...
(2, 'mnonym', 'priv not definition'),
(3, 'opr', 'priv for everyone can use a'),
(4, 'opr opr', 'oprrrr');
...
('13fasfasf', 'opr', '21232f297a57a5a743894a0e4a801fc3', 4, '2018-10-10 00:00:00', '0'),
...
('df492639-977a-4ef6-bba8-4207de5eedb7', 'admin4', '21232f297a57a5a743894a0e4a801fc3', 2, '2018-12-15 05:48:02', '0');
...
('asjkhakjsha', 'administrator atua', 'admin@localhost.com', 'yoiyoi', 'asjkhakjsha.png');
...
--
ALTER TABLE `tbl_user_log`
  MODIFY `number` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=132;
--
